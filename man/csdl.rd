...
\description{
French stocks (Cac40, Société générale, Danone, L'Oréal) for the period 2006 - 2009, on Euronext Paris.}
\usage{data(csdl)}
...
\item \code{Socgen}, GLE.PA (name of the quote symbol), Société générale
\item \code{Danone}, BN.PA (name of the quote symbol), Danone
\item \code{L_Oreal}, OR.PA (name of the quote symbol), L'Oréal
}
